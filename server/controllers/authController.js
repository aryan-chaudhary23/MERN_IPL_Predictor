...
export const register = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Welcome to IPL Win Predictor',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #ddd; border-radius: 8px; padding: 20px; background-color: #f9f9f9;">
                    <header style="text-align: center; padding: 20px 0; background-color: #4CAF50; color: white; border-radius: 8px 8px 0 0;">
                        <h1 style="margin: 0; font-size: 24px;">IPL Win Predictor</h1>
                    </header>
                    <main style="padding: 20px; text-align: left;">
                        <h2 style="color: #333;">Hello ${name},</h2>
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">
                            Welcome to <strong>IPL Win Predictor</strong>! We are thrilled to have you on board.
                        </p>
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">
                            With our tools and insights, you'll have access to powerful features to help you make informed decisions about IPL matches.
                        </p>
                        <p style="font-size: 16px; line-height: 1.6; color: #555;">
                            If you have any questions or need assistance, feel free to reach out to our support team at <a href="mailto:support@iplwinpredictor.com" style="color: #4CAF50;">support@iplwinpredictor.com</a>.
                        </p>
                    </main>
                    <footer style="text-align: center; padding: 20px 0; color: #999; font-size: 14px; background-color: #f1f1f1; border-radius: 0 0 8px 8px;">
                        &copy; ${new Date().getFullYear()} IPL Win Predictor. All rights reserved.
                    </footer>
                </div>
            `
        };
            ...
            html: `
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="footer">
                            <p>&copy; ${new Date().getFullYear()} IPL Win Predictor. All rights reserved.</p>
